Where3x3.MapView = {
  ...
  showStaticMap: function(lat, lng, size){
    var $imgurl = $('<img>');
    var latlng = lat + ',' + lng;
    var key = "key=AIzaSyB8pqPpYhPhCttU1OnLJY_qcbFOpWagtZM";
    $imgurl.attr('src', 'https://maps.googleapis.com/maps/api/staticmap?center=' +
      latlng + '&' + key +
      '&zoom=15&size=' + size + 'x' + size +
      '&markers=color:red%7Clabel:C%7C' + latlng);
